...
const contributors = {
  ...
  args: {
    ...
    last: {
      type: GraphQLInt,
      description:
        '[NOT IMPLEMENTED YET] Returns the last n elements from the list.',
    },
    after: {
      type: GraphQLString,
      description:
        '[NOT IMPLEMENTED YET] Returns the elements in the list that come after the specified cursor.',
    },
    before: {
      type: GraphQLString,
      description:
...
const contributor = {
  ...
  args: {
    login: {
      ...
      description:
        'Login of the contributor. It will be null if the user is not a Contributor or GitHub User',
    },
  },
